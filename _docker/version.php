<?php
	...
	***********************************************************************************************************/		
		...
		*******************************************************************************************************/
		...
		/*******************************************************************************************************
			Module Github Website
			 - can be false
		*******************************************************************************************************/
		$x["github"] 			= "https://github.com/bugfishtm/sf-dk-docker";	
	...
	/***********************************************************************************************************
		Dedicated Docker Module Commands
	***********************************************************************************************************/
	$x["cmd"] = array();
		...
		*******************************************************************************************************/
		$x["cmd"][0] = array();
		$x["cmd"][0]["button_label"] 			= "command_dir";
		$x["cmd"][0]["button_description"] 		= "command_dir_descr";
		$x["cmd"][0]["command"] 				= "dir /";
		...
		*******************************************************************************************************/
		$x["cmd"][1] = array();
		$x["cmd"][1]["button_label"] 			= "command_cat";
		$x["cmd"][1]["button_description"] 		= "command_cat_descr";
		$x["cmd"][1]["command"] 				= "cat /etc/passwd";	
